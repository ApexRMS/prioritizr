...
if(fileExtension == "tif"){
  ...
  solutionRasterDatasheet <- rbind(solutionRasterDatasheet, temp_solutionRasterDatasheet)
...
if(fileExtension == "csv"){
    # Save file path to datasheet
  solutionTabularDatasheet <- rbind(solutionTabularDatasheet, scenarioSolution[,-1])
  saveDatasheet(ssimObject = myScenario, 
